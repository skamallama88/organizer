...
- [x] Attempt list and detail views show source identity, planned actions, action results, evidence, failure detail, suppressions, and linked attempts.
- [x] Reconciliation acceptance creates immutable accepted action results; uncertain actions and later actions remain blocked without conclusive evidence.
- [x] Abandoning creates a terminal abandoned attempt and suppression; reopening is auditable and starts a fresh plan while preserving history.
